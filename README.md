...
local Window = OrionLib:MakeWindow({Name = "Dracule Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Dracule Hub"})
...
W:AddLabel("[+] Dracule Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Dracule Hub(Noitification)",
